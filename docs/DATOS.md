...
| `cobertura_pct` | Porcentaje de la ventana de actividad (de la primera a la última cubeta activa del día) que llegó **medido**. Una cubeta cubre lo que dice `bucket_ms` o lo que suman sus `foreground_ms` si es más (un tramo fundido cuyo ancho se guardó recortado). Baja de verdad cuando el PC se apaga o suspende o el medidor muere en medio del día. |
