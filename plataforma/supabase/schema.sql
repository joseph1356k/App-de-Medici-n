...
values (1, 'Hospital General de Medellín', 1, jsonb_build_object(
  ...
  'apps_por_proceso', '{
    ...
    "powershell.exe":"escritorio", "windowsterminal.exe":"escritorio", "notepad.exe":"notepad",
    "wordpad.exe":"wordpad", "mspaint.exe":"paint", "calc.exe":"calculadora",
    "calculator.exe":"calculadora", "stickynot.exe":"notas_rapidas", "snippingtool.exe":"recortes",
